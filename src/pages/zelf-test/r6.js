  ...
  <>
    <div className="ontario-row">
      ...
      <div className="ontario-small-10 ontario-medium-11 ontario-large-10 ontario-end ontario-columns ontario-results__content">
        ...
        <ol>
          <li>
            <AnchorLink to="/zelf-test/r6#stay-at-home">Stay at home for 14 days</AnchorLink>
          </li>
          <li>
            <AnchorLink to="/zelf-test/r6#monitor-your-health">Monitor your health</AnchorLink>
          </li>
        </ol>
      </div>
    </div>
...
const R6 = () => <ResultsTemplate lang="nl" resultsContent={resultsContent} />

  ...
  <>
    <div className="ontario-row">
      ...
      <div className="ontario-small-10 ontario-medium-11 ontario-large-10 ontario-end ontario-columns ontario-results__content">
        ...
        <ol>
          <li>
            <AnchorLink to="/zelf-test/r4#stay-at-home">Stay at home</AnchorLink>
          </li>
          <li>
            <AnchorLink to="/zelf-test/r4#monitor-your-health">Monitor your health</AnchorLink>
          </li>
        </ol>
      </div>
    </div>
...
const R4 = () => <ResultsTemplate lang="nl" resultsContent={resultsContent} />

  ...
  <>
    <div className="ontario-row">
      ...
      <div className="ontario-small-10 ontario-medium-11 ontario-large-10 ontario-end ontario-columns ontario-results__content">
        ...
        <ol>
          <li>
            <AnchorLink to="/zelf-test/r2#stay-at-home">Stay at home for 14 days</AnchorLink>
          </li>
          <li>
            <AnchorLink to="/zelf-test/r2#tell-people-youve-been-in-contact-with">
              Tell people you’ve been in contact with
            </AnchorLink>
          </li>
          <li>
            <AnchorLink to="/zelf-test/r2#monitor-your-health">Monitor your health</AnchorLink>
          </li>
        </ol>
      </div>
    </div>
...
const R2 = () => <ResultsTemplate lang="nl" resultsContent={resultsContent} />

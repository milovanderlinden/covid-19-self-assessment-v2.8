  ...
  <>
    <div className="ontario-row">
      ...
      <div className="ontario-small-10 ontario-medium-11 ontario-large-10 ontario-end ontario-columns ontario-results__content">
        ...
        <ol>
          <li>
            <AnchorLink to="/zelf-test/r5#stay-at-home">Stay at home for 14 days</AnchorLink>
          </li>
          <li>
            <AnchorLink to="/zelf-test/r5#monitor-your-health">Monitor your health</AnchorLink>
          </li>
        </ol>
      </div>
    </div>
...
const R5 = () => <ResultsTemplate lang="nl" resultsContent={resultsContent} />

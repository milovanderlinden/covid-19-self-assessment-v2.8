  ...
  <>
    <div className="ontario-row">
      ...
      <div className="ontario-small-10 ontario-medium-11 ontario-large-10 ontario-end ontario-columns ontario-results__content">
        ...
        <ol>
          <li>
            <AnchorLink to="/zelf-test/r3#avoid-going-out">Avoid going out in public</AnchorLink>
          </li>
          <li>
            <AnchorLink to="/zelf-test/r3#monitor-your-health">Monitor your health</AnchorLink>
          </li>
        </ol>
      </div>
    </div>
...
const R3 = () => <ResultsTemplate lang="nl" resultsContent={resultsContent} />

  ...
  <>
    ...
    <div className="ontario-row ontario-results__content">
      ...
      <div className="ontario-small-10 ontario-medium-11 ontario-large-10 ontario-end ontario-columns">
        ...
        <ol>
          <li>
            <AnchorLink to="/zelf-test/r7#stay-at-home">
              Stay at home unless told to leave by a doctor or nurse
            </AnchorLink>
          </li>
          <li>
            <AnchorLink to="/zelf-test/r7#tell-people-youve-been-in-contact-with">
              Tell people you’ve been in contact with
            </AnchorLink>
          </li>
          <li>
            <AnchorLink to="/zelf-test/r7#monitor-your-health">Monitor your health</AnchorLink>
          </li>
        </ol>
      </div>
    </div>
...
const R7 = () => <ResultsTemplate lang="nl" resultsContent={resultsContent} />
